    ...
    public function handle()
    {
        try {
            ...
            foreach($teams as $team) {
                ...
                // defence
                $formation_id = 0;
                if($dl = 3 && $lb = 4) $formation_id = 14;
                if($dl = 4 && $lb = 3) $formation_id = 15;
                if($dl = 4 && $lb = 4) $formation_id = 16;
                if($dl = 5 && $lb = 2) $formation_id = 17;
                if($formation_id === 0) $formation_id = 15;
                ...
                // dump($season.' '.$team.' (defence) : '.$formation_id);
                // dump($season.' '.$team.' (offence) : '.'dl: '.$dl.', lb:'.$lb.', formation:'.$formation_id);
